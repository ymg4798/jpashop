...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findAllByDto_optimization() {
        List<OrderQueryDto> result = findOrders(); //루프 안돌게

        Map<Long, List<OrderItemQueryDto>> orderItemMap = findOrderItemMap(toOrderIds(result)); // 주문 데이터만큼 맵의 메모리에 올린다.

        result.forEach(o -> o.setOrderItems((orderItemMap.get(o.getOrderId())))); // 루프를 돌면서 컬렉션을 채워준다.
